...
export const metadata: Metadata = {
  ...buildSeoMetadata({
    title: 'StudyHelp – AI-Powered CBT Practice for Nigerian University Students',
    description:
      'Turn your lecturer notes into CBT practice questions instantly. StudyHelp is the #1 AI-powered study platform for JAMB, WAEC, NECO & Post-UTME — with real-time analytics, past questions, and an AI study tutor. Completely free to start.',
    path: '/',
    keywords: [
      'CBT practice for Nigerian students',
      'JAMB past questions 2024',
      'WAEC past questions',
      'NECO past questions',
      'Post-UTME practice',
      'AI CBT practice Nigeria',
      'convert notes to questions',
      'AI study tutor Nigeria',
      'online study tools Nigeria',
      'university exam prep Nigeria',
      'AI-powered CBT Nigeria',
      'study help JAMB',
      'studyhelp past question',
      'Nigerian student study app',
      'free CBT practice Nigeria',
      'JAMB preparation platform',
      'WAEC preparation online',
      'education technology Nigeria',
      'AI exam questions generator',
