...
export default function ProgressAnalytics() {
    ...
    if (!hasData) {
        return (
            <div className="bg-white dark:bg-gray-800 p-12 rounded-3xl shadow-sm border border-gray-100 dark:border-gray-700 text-center animate-in fade-in duration-500">
