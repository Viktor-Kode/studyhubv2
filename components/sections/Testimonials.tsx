...
import { FaChevronLeft, FaChevronRight, FaUserGraduate, FaBuilding } from 'react-icons/fa'

const studentTestimonials = [
  {
    quote:
      'The AI-generated practice questions helped me improve my test scores by 30%. The personalized difficulty adjustment is perfect.',
    author: 'Sarah Chen',
  ...
  {
    quote:
      'The 24/7 availability is a game-changer. I can practice with AI questions whenever I need, even during late-night study sessions.',
...
const adminTestimonials = [
  {
    quote:
      "Standardized question quality across all courses has improved our institution's academic standards significantly.",
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-white/60 max-w-3xl mx-auto">
              Hear from students and school leaders using StudyHelp
            </p>
          </div>
          ...
          <div className="testimonial-section mb-12">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="text-2xl font-bold text-white">Student stories</h3>
            </div>
            <div className="relative">
              ...
              <div className="relative bg-white/5 backdrop-blur-md border-l-4 border-emerald-500 border border-white/10 rounded-xl p-8">
                <div className="absolute top-4 left-4 text-6xl font-bold text-emerald-500/20 font-serif">&ldquo;</div>
                  ...
                  {studentTestimonials.map((_, index) => (
                    <button
                      ...
                      className={`h-2 rounded-full transition-all duration-300 ${
                        index === studentIndex ? 'bg-emerald-400 w-8' : 'bg-white/20 w-2 hover:bg-white/40'
                      }`}
          ...
          <div className="testimonial-section">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="text-2xl font-bold text-white">Schools and programs</h3>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-1 gap-6">
              {adminTestimonials.map((testimonial, index) => (
                <div
                  key={index}
                  className="relative bg-white/5 backdrop-blur-md border-l-4 border-purple-500 border border-white/10 rounded-xl p-6"
                >
                  <div className="absolute top-4 left-4 text-4xl font-bold text-purple-500/20 font-serif">&ldquo;</div>
                  <blockquote className="text-white/90 leading-relaxed mb-4 relative z-10">{testimonial.quote}</blockquote>
