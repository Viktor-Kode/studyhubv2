...
export default function AiTutorPage() {
  ...
  return (
    <ProtectedRoute>
      <div className="flex flex-col h-[100dvh] w-full overflow-hidden bg-gray-50 dark:bg-gray-950 text-gray-900 dark:text-gray-100 animate-in fade-in duration-200">
        
        {/* Top Header */}
        <header className="sticky top-0 z-20 flex items-center justify-between px-4 pb-3 pt-[max(14px,env(safe-area-inset-top))] bg-white/95 dark:bg-gray-900/95 backdrop-blur border-b border-gray-200 dark:border-gray-800 flex-shrink-0 shadow-sm">
          {/* Back link — icon only on mobile, shows label on sm+ */}
          <a
            href="/dashboard/student"
            className="flex items-center gap-1.5 px-2.5 py-1.5 bg-gray-100/80 dark:bg-gray-800/80 hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-200 rounded-xl text-xs font-semibold transition"
          >
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="m12 19-7-7 7-7"/><path d="M19 12H5"/></svg>
        ...
        {showHistory && (
          <div className="fixed inset-0 z-[150] flex justify-end">
            ...
            <div className="relative h-full w-80 max-w-[85vw] bg-white dark:bg-gray-900 shadow-2xl flex flex-col z-10 animate-in slide-in-from-right duration-250">
              {/* Drawer Header */}
              <div className="flex items-center justify-between px-4 pb-3 pt-[max(16px,env(safe-area-inset-top))] border-b border-gray-200 dark:border-gray-800 bg-gray-50/80 dark:bg-gray-900/80">
                ...
                <button
                  onClick={() => setShowHistory(false)}
                  className="p-2 hover:bg-gray-200 dark:hover:bg-gray-800 rounded-xl text-gray-500 dark:text-gray-400 transition"
