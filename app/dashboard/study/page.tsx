...
const STUDY_TOOLS = [
  {
    ...
    description: 'Real WAEC, JAMB, NECO past exam questions by subject & year',
    href: '/dashboard/cbt',
  },
  {
    id: 'tutor',
    ...
    iconBg: 'var(--green-bg)',
    title: 'AI Tutor',
    description: 'Ask questions, explain topics, or study with your notes',
  ...
  },
  {
    ...
    description: 'Generate custom AI practice questions for any subject or topic',
